...
// Xtime2Sbox have taken from https://code.google.com/archive/p/byte-oriented-aes/
// because of fastEncrypt function. MixColumns, SubBytes, and ShiftRows steps
// are combined into a single round operation.
// combined Xtimes2[Sbox[]]
BYTE Tables::Xtime2Sbox[256] = {
...
// Xtime3Sbox have taken from https://code.google.com/archive/p/byte-oriented-aes/
// because of fastEncrypt function. MixColumns, SubBytes, and ShiftRows steps
// are combined into a single round operation.
// combined Xtimes3[Sbox[]]
BYTE Tables::Xtime3Sbox[256] = {
...
// Rcon table
BYTE Tables::rcon[16] = {0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36, 0x6c, 0xd8, 0xab, 0x4d, 0x9a};
